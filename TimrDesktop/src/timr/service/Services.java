...
public class Services {
    ...
    static public void solveNotification(String user, String _id){
        try {         
            new SOAPClient(URL)
                    .addCallName(SolveNotification,NAMESPACE)
                    .addParameter("notificationId", _id)
    ...
    static public void updateSite(String student,String oldLink, String newLink) {
        try {         
            new SOAPClient(URL)
                    .addCallName(UpdateSite,NAMESPACE)
                    .addParameter("username", student) 
                    .addParameter("oldLink", oldLink)
                    .addParameter("newLink", newLink)
                    .call();
        } catch (Exception e) {
           // e.printStackTrace();
           TimrError.show(e.getMessage());
    ...
    static public void insertFeed(String faculty, String teacher, List<String> groups, String message){
        try {         
            new SOAPClient(URL)
                    .addCallName(InsertFeed,NAMESPACE)
                    .addParameter("username", "")       //TODO: remove when necessary
                    .addParameter("faculty", faculty)
                    .addParameter("feed", XmlParser.createFeed(teacher, groups, message))
                    .call();
        } catch (Exception e) {
           // e.printStackTrace();
           TimrError.show(e.getMessage());
    ...
    static public Prof getTeacherXML(String teacher){
        try {
                return XmlParser.parseProf(
                        XmlHeader
                        + new SOAPClient(URL)
                            .addCallName(TeacherXML,NAMESPACE)
                            .addParameter("teacherId", teacher)                    
                            .call());
        } catch (Exception e) {
           // e.printStackTrace();
           TimrError.show(e.getMessage());
    ...
    static public List<Faculty> getTeacherFaculties(String teacher){
        try {
                return XmlParser.parseFaculties(
                        XmlHeader
                        + new SOAPClient(URL)
                            .addCallName(TeacherFaculties,NAMESPACE)
                            .addParameter("teacherId", teacher)                    
                            .call());
        } catch (Exception e) {
            TimrError.show(e.getMessage());
    ...
    static public Map<String,String> getGroups(String faculty){
        try {
                return XmlParser.parseGroups(
                        XmlHeader
                        + new SOAPClient(URL)
                            .addCallName(GetAllGroups,NAMESPACE)
                            .addParameter("facultyId", faculty)                    
                            .call());
        } catch (Exception e) {
            TimrError.show(e.getMessage());
        } 
    ...
    static public void insertSite(String user, String website, String subjectId){
        try {
                ...
                new SOAPClient(URL)
                            .addCallName(InsertSite,NAMESPACE)
    ...
    static public List<Message> getStudentNotifications(String user, int count, boolean unsolved){
        try {
                return XmlParser.parseStudentNotifications(
                        XmlHeader +new SOAPClient(URL)
                            .addCallName(StudentNotifications,NAMESPACE)
                            .addParameter("username", user)
                            .addParameter("count", String.valueOf(count))
                            .addParameter("getOnlyUnsolvedNotifications", String.valueOf(unsolved))
                            .call());
        } catch (Exception e) {
            TimrError.show(e.getMessage());
        } 
    ...
    static public boolean validateUser(String user, String pass){
         try {            
                   return Boolean.parseBoolean(new SOAPClient(URL)
                    .addCallName(ValidateUser,NAMESPACE)
                    .addParameter("username", user)
    ...
    static public Stud getStudentXML(String student){
        try {
                ...
                return XmlParser.parseStudent(
                        XmlHeader
                        + new SOAPClient(URL)
                            .addCallName(StudentXML,NAMESPACE)
                            .addParameter("username", student)                    
                            .call());
        } catch (Exception e) {
           // e.printStackTrace();
    ...
    static public Map<String,String> getSubjects(String student){
        try {
                ...
                return XmlParser.parseSubjects(
                        XmlHeader
                        + new SOAPClient(URL)
                            .addCallName(SubjectsXML,NAMESPACE)
                            .addParameter("username", student)                    
                            .call());
        } catch (Exception e) {
            TimrError.show(e.getMessage());
    ...
    static public boolean insertUser(String username, String pass, String email, int type) {
        try {                    
                    return Boolean.parseBoolean(new SOAPClient(URL)
                    .addCallName(InsertUser,NAMESPACE)
                    .addParameter("username", username)
                    .addParameter("password", pass)
                    .addParameter("email",email)
                    .addParameter("userType", UserType.fromInt(type).toString()).call());
        } catch (Exception e) {
            TimrError.show(e.getMessage());
        } 
        return false;
    ...
    static public Timetable getTimetableForUser(String user, String faculty) {
        try {
            return XmlParser.parseTimetable(
                    XmlHeader
                    + new SOAPClient(URL)
                    .addCallName(TimetableUser,NAMESPACE)
                    .addParameter("username",user)
                    .addParameter("faculty",faculty)
                    .call());
        } catch (Exception e) {
    ...
    static public Timetable getTimetableForBachelorYear(String year,
        ...
        try {
            return XmlParser.parseTimetable(
                    XmlHeader
                    + new SOAPClient(URL)
                    .addCallName(TimetableBachelor,NAMESPACE)
    ...
    static public Timetable getTimetableForMastersYear(String year) {
        try {
            return XmlParser.parseTimetable(
                    XmlHeader
                    + new SOAPClient(URL)
                    .addCallName(TimetableMasters,NAMESPACE)
